...
\makeatletter
  ...
  \setlength\textwidth{480\p@} % before: {345\p@}
  \setlength\@tempdima{\paperheight}
  \addtolength\@tempdima{-2in} % before: {-3.5in}
  ...
  \setlength\oddsidemargin    {.6\@tempdima} % before: {.4\@tempdima}
  \addtolength\oddsidemargin  {-1in}
  \setlength\marginparwidth   {.4\@tempdima} % before: {.6\@tempdima}
